...
namespace FastScreenCapture.Controls
{
    public class TextTool : StackPanel
    {
        ...
        public static readonly DependencyProperty FontSizeProperty =
                DependencyProperty.Register(nameof(FontSize), typeof(int), typeof(TextTool),
        ...
        public static readonly DependencyProperty LineBrushProperty =
                DependencyProperty.Register(nameof(LineBrush), typeof(SolidColorBrush), typeof(TextTool),
