...
namespace FastScreenCapture
{
    public class AppModel : EntityBase
    {
        ...
        private double _MaskLeftWidth = ScreenCaptureWindow.ScreenWidth;
        ...
        {
            sb.Clear();
            sb.Append((int)(ScreenCaptureWindow.Current.MainImage.Width * ScreenCaptureWindow.ScreenScale));
            sb.Append(" × ");
            sb.Append((int)(ScreenCaptureWindow.Current.MainImage.Height * ScreenCaptureWindow.ScreenScale));
