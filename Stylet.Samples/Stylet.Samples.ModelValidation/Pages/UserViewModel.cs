...
namespace Stylet.Samples.ModelValidation.Pages
{
    public class UserViewModel : Screen
    {
        ...
        public UserViewModel(IWindowManager windowManager, IModelValidator<UserViewModel> validator)
            : base(validator)
        {
    ...
    public class UserViewModelValidator : AbstractValidator<UserViewModel>
    {
        public UserViewModelValidator()
        {
            ...
            RuleFor(x => x.PasswordConfirmation).Equal(s => s.Password)
                        .WithMessage("{PropertyName} should match Password");
            RuleFor(x => x.Age).Must(x => x.IsValid)
